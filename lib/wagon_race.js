...
document.addEventListener("keyup", (event) => {
  if (event.key === "y" && yoshiPosition > 0) {
    ...
    container.insertAdjacentHTML("beforeend", "<br><br><img src='images/peachwin.png' id='peach'></img><h1>PEACH WINS!!!<br><br><img class='goldStar' style='width: 100px' src='images/goldstar.png'></img><br>CLICK me TO GO AGAIN!</h1><br><br>");
    audio.play();
    ...
    entireTrack.remove();
    dividers.forEach(divider => divider.remove());
    container.insertAdjacentHTML("beforeend", "<br><br><img id='yoshi' src='images/yoshiwins.jpeg'></img><h1>YOSHI WINS!!!<br><br><img class='goldStar' style='width: 100px' src='images/goldstar.png'></img><br>CLICK me TO GO AGAIN!</h1><br><br>");
    audio.play();
    const goldStar = document.querySelector(".goldStar");
    goldStar.addEventListener("click", thing => document.location.reload());
  }
